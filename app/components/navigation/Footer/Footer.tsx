...
export default function Footer() {
  return (
    <footer className=" text-baseSecondary pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            <h3 className="text-2xl font-bold mb-6">Altruvist</h3>
            <p className="mb-6">Creating tangible, meaningful impact while rewarding volunteers and charities alike</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/dashboard" className="hover:text-accentPrimary transition-colors">Dashboard</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold text-lg mb-6">Resources</h4>
            <ul className="space-y-3">
              <li><Link to="/about#how-it-works" className="hover:text-accentPrimary transition-colors">How it Works</Link></li>
              <li><Link to="/faq" className="hover:text-accentPrimary transition-colors">FAQ</Link></li>
              <li><Link to="/volunteer-guide" className="hover:text-accentPrimary transition-colors">Volunteer Guide</Link></li>
              <li><Link to="/charity-resources" className="hover:text-accentPrimary transition-colors">Charity Resources</Link></li>
              <li><Link to="/contact" className="hover:text-accentPrimary transition-colors">Contact</Link></li>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input
                ...
                className="px-4 py-2 placeholder:text-baseSecondary/50 bg-basePrimary/40 rounded-lg text-baseSecondary  focus:outline-none focus:ring-2 focus:ring-accentPrimary border border-baseSecondary"
              />
              <motion.button
