...
export const loader = async () => {
  ...
  return json({
    ...
    team: [
      { name: "Alex Johnson", role: "Founder", image: "/images/placeholder-profile.png" },
      { name: "Sam Richards", role: "Chief Technology Officer", image: "/images/placeholder-profile.png" },
      { name: "Taylor Smith", role: "Community Manager", image: "/images/placeholder-profile.png" }
    ],
    testimonials: [
      {
        quote: "Altruvist has transformed how we find skilled volunteers for our technical needs.",
        author: "Jane Doe",
        title: "Director, Ocean Conservation Trust"
      },
      {
        quote: "As a web developer, I've found meaningful ways to contribute my skills to causes I care about.",
        author: "Marcus Lee",
          ...
          >
            <div className="space-y-2 mb-4">
              ...
              <p className="mx-auto max-w-[700px] text-midGrey md:text-xl">
                Connecting skilled volunteers with charities that need their expertise
              </p>
            </div>
            <motion.div
            ...
            >
              <div className="bg-accentPrimary p-8 rounded-xl">
                <p className="text-lg text-midGrey leading-relaxed">
                  Altruvist is a platform that bridges the gap between skilled professionals and charitable organizations. 
                  We believe everyone has valuable skills that can make a difference, and we make it easy to donate those skills to causes that matter.
                </p>
              </div>
            </motion.div>
          </motion.div>
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-midGrey">
                  <li className="flex items-center">
                    <svg className="w-5 h-5 mr-2 text-confirmPrimary" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <li className="flex items-center">
                    ...
                    <span>Provide meaningful volunteer opportunities for skilled professionals</span>
                  </li>
                  <li className="flex items-center">
                    <svg className="w-5 h-5 mr-2 text-confirmPrimary" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span>Maximize social impact through efficient skill matching</span>
                  </li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              <div className="absolute inset-0 bg-accentPrimary rounded-xl flex items-center justify-center">
                <div className="text-center p-8">
                  <h3 className="text-2xl font-bold mb-4 text-baseSecondary">Our Impact</h3>
                  <div className="grid grid-cols-2 gap-4">
                    {stats.map((stat, i) => (
                      ...
                      >
                        <p className="text-3xl font-bold text-baseSecondary">{stat.value}</p>
            ...
            {[
              {
                ...
                description: "Charitable organizations post specific tasks requiring professional skills",
                icon: "📋",
              },
              {
                title: "Volunteers Apply",
                description: "Skilled volunteers browse and apply for tasks matching their expertise",
                icon: "🤝",
              },
              {
                title: "Collaboration",
                description: "Work together to complete tasks and track progress on our platform",
                icon: "✨",
              }
            ].map((step, i) => (
              <motion.div 
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-2 text-baseSecondary">{step.title}</h3>
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full ${
                    i === activeTestimonial ? "bg-basestext-baseSecondary" : "bg-lightGrey"
                  }`}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {team.map((member, i) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-baseSecondary">{member.name}</h3>
          ...
          >
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="mt-4 text-basePrimaryLight max-w-md mx-auto md:mx-0">
                Join our community of skilled volunteers making a difference by donating their expertise to worthy causes.
              </p>
            </div>
