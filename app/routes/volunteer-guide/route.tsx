...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "A comprehensive guide for volunteers on how to make the most of your volunteering experience with Altruist.",
    },
  ];
};
    ...
    steps: [
      {
        ...
        icon: "👤",
        description: "Sign up and complete your profile with skills, interests, and availability to help us match you with the right opportunities.",
        tips: [
      ...
      },
      {
        ...
        icon: "🔍",
        description: "Browse available tasks that match your skills and interests, or wait for our matching algorithm to suggest opportunities.",
        tips: [
      ...
      },
      {
        title: "Apply & Connect",
        icon: "🤝",
        description: "Submit your application for projects you're interested in and connect with the organization to learn more.",
        tips: [
      ...
      },
      {
        ...
        icon: "🌟",
        description: "Complete your assigned tasks and track your social impact over time on your personalized dashboard.",
        tips: [
    ...
    tips: [
      {
        ...
        description: "Maintain clear and regular communication with the organization. If you're running late, need clarification, or can't complete a task, let them know as soon as possible."
      },
      {
        title: "Manage Your Time",
        description: "Be realistic about your availability and only commit to what you can deliver. It's better to excel at one project than to underperform on several."
      },
      {
        title: "Keep Learning",
        description: "Use each volunteer opportunity to develop new skills and knowledge. Ask for feedback and be open to constructive criticism."
      },
      {
        title: "Document Your Work",
        description: "Keep samples of your volunteer work (when appropriate and with permission) to showcase your skills and impact in the future."
      },
      {
        title: "Build Relationships",
        description: "Volunteering is a great way to network and build professional relationships. Connect with other volunteers and organization staff on professional networks."
      }
    ]
  });
};
        ...
        <div className="container relative px-4 md:px-6 mx-auto py-16 md:py-20 lg:py-24">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              Volunteer <span className="text-baseSecondary text-6xl">Guide</span>
              </h1>
              <p className="mt-4 text-lg text-midGrey max-w-2xl mx-auto">
                Everything you need to know to make the most of your volunteering experience
                with Altruist.
              </p>
            </motion.div>
              ...
              {steps.map((step, i) => (
                ...
                >
                  ...
                  <div className="mt-4 bg-basePrimary/50 p-3 rounded-lg">
                    <p className="font-medium text-baseSecondary text-sm mb-2">Pro Tips:</p>
                    <ul className="space-y-2 text-sm">
                      {step.tips.map((tip, j) => (
                        <li key={j} className="flex items-start">
                          <span className="text-accentPrimary mr-2 mt-0.5">•</span>
