        ...
        <>
            ...
            <section className="py-20 bg-gradient-to-b from-baseSecondary to-baseSecondary/70 text-basePrimary">
                <div className="container mx-auto px-6">
                    ...
                    >
                        <h2 className="text-4xl font-bold mb-4 text-accentPrimary/80">Success Stories</h2>
                        <div className="w-24 h-1 bg-accentSecondary mx-auto mb-6"></div>
                        <p className="text-lg max-w-xl mx-auto">
                            See how volunteers have transformed charities through their digital expertise.
                        </p>
                    </motion.div>
                    ...
                    <div className="max-w-7xl mx-auto">
                        ...
                        >
                            <div className="grid md:grid-cols-2 gap-0">
                                <div className="p-8 md:p-12 flex flex-col justify-center">
                                    <span className="text-sm font-semibold text-accentSecondary mb-4 uppercase tracking-wider">Featured Case Study</span>
                                    <h3 className="text-2xl md:text-3xl font-bold mb-4 text-accentPrimary">Wildlife Conservation Dashboard</h3>

                                    <p className="mb-6 text-basePrimary">
                                        A team of data scientists and frontend developers created an interactive dashboard
                                        helping GlobalWild track endangered species across 20 countries.
                                    </p>
                                    ...
                                    >
                                        <div className="flex items-start gap-4">
                                            <div className="w-12 h-12 rounded-full bg-accentPrimary/20 overflow-hidden flex-shrink-0">
                                                <img src="/avatar-person.png" alt="Dr. Sarah Chen" className="w-full h-full object-cover" />
                                            </div>
                                            <div>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {[
                                ...
                                >
                                    <div className={`h-48 relative overflow-hidden bg-gradient-to-br ${caseStudy.color}`}>
                                        <img
                                            src={caseStudy.image}
                                            alt={caseStudy.title}
                                    ...
                                    <div className="p-6">
                                        <h3 className="text-xl font-bold mb-2 text-accentPrimary">{caseStudy.title}</h3>
                                        <p className="text-sm text-basePrimary mb-4">{caseStudy.charity}</p>
                        ...
                        >
                            <div className="text-center mb-8">
                                <h3 className="text-2xl font-bold text-accentPrimary mb-2">Combined Impact</h3>
                                <p className="text-basePrimary">Our case studies demonstrate the tangible difference skilled volunteers make</p>
                            </div>

                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                                {[
                                    { value: "$1.2M", label: "Value of Work Donated", icon: <Trophy size={28} weight="fill" /> },
                                    { value: "2,500+", label: "Volunteer Hours", icon: <Clock size={28} weight="fill" /> },
                                    { value: "45+", label: "Projects Completed", icon: <Target size={28} weight="fill" /> },
                                    { value: "32", label: "Charities Supported", icon: <Buildings size={28} weight="fill" /> }
                                ].map((stat, index) => (
                                    <motion.div
                                        key={index}
                                    ...
                                    >
                                        ...
                                        <p className="text-sm text-basePrimary mt-1">{stat.label}</p>
                                    </motion.div>
                                ))}
                            </div>
                            ...
                            <motion.div
                                ...
                                whileTap={{ scale: 0.98 }}
                            >
                                <Link to="/case-studies" className="inline-block px-8 py-3 bg-accentPrimary text-baseSecondary rounded-lg font-medium hover:bg-accentPrimaryDark transition-colors">
